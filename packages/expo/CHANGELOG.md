...
- [Android] Added bridgeless support on ReactNativeHostHandler and drop support. Also dropped support for React Native 0.73 and lower. ([#27629](https://github.com/expo/expo/pull/27629) by [@kudo](https://github.com/kudo))
